...
BEGIN
    ...
    ce_timer <= '1' when (currState = STATE_ACKNOWLEDGE AND Kpress = '1') else '0';
    
    
    reset_timer <= '1' when (currState /= STATE_ACKNOWLEDGE OR Kpress = '0' OR CLEAR = '1') else '0';
